...
Treat any value that reached a file as COMPROMISED:
  ...
  3. Supply it at runtime instead — see .claude/standards/security.md. Nothing in
     apps/web/src/environments/ or apps/web/public/env.js holds a real value; the
     deployment injects them through docker/40-env.sh.
