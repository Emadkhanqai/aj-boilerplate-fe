...
> One file per decision. Number them sequentially: `0005-short-slug.md`. Never rewrite history
...
>
> Write an ADR when a decision is expensive to reverse, affects more than one team or crosses a
> library boundary, constrains future work, or when you can already imagine someone asking "why
> on earth is it like this?" six months from now. Do not write one for a choice a single pull
> request can undo.
